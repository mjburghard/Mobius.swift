...
///  - `.onMainActor.to { effect in ... }` and `.onMainActor.toEvent { effect in ... }`: Main-actor-isolated
///    versions of the closure-based targets. These are equivalent to routing `.on(queue: .main)` but keep the closures
